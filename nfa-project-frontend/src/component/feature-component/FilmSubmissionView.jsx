...
const FilmSubmissionView = ({ data = {} }) => {
    ...
    const handleHardCopy = (type = 'DOWNLOAD', isCharges = false) => {
        ...
        // ✅ Restore buttons immediately after canvas render
        ...
        <div className="card-box">
            <div className="container py-4" ref={invoiceRef} id="invoiceBox">
                ...
                <div className="d-flex justify-content-between">
                    <NavLink to={'/dashboard'} className="btn btn-outline-primary no-print">Dashboard</NavLink>
                    <button className="btn btn-success no-print" onClick={() => handleHardCopy('DOWNLOAD', true)}>Print</button>
                </div>
            </div>
        </div>
    );
